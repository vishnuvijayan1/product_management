...
@section('title', __('messages.add_attribute'))
@push('breadcrumbs')
    <!--begin::Item-->
    ...
    <!--end::Item-->
    <!--begin::Item-->
    <li class="breadcrumb-item active"><a href="" class="text-muted text-hover-primary">{{  __('messages.add_attribute') }}</a></li>
    <!--end::Item-->
@endpush
@section('content')
    <!--begin::Content-->
                ...
                <div class="col-md-12 col-lg-12 col-xl-12 col-xxl-12 mb-md-5 mb-xl-10">
                    <div class="card">
                        ...
                        <div class="card-body pt-0">
                            <form class="form" action="#" id="addAttributeForm" enctype="multipart/form-data" method="POST">
                                <!--begin::Modal body-->
                                <div class="modal-body py-10 px-lg-17">
                                        ...
                                        <div class="row g-9 mb-7">
                                            ...
                                            <div class="col-md-12 fv-row fv-plugins-icon-container">
                                                ...
                                                <!--end::Label-->
                                                <!--begin::Input-->
                                                <input type="text"class="form-control" placeholder="{{ __('messages.attribute_code') }}" name="code" dir="ltr">
                                                <!--end::Input-->
                                        ...
                                        <div class="row g-9 mb-7">
                                            ...
                                            <div class="col-md-6 fv-row fv-plugins-icon-container">
                                                ...
                                                <!--end::Label-->
                                                <!--begin::Input-->
                                                <input type="text"class="form-control" placeholder="{{ __('messages.attribute_name') }} ({{ __('messages.en') }})" name="name" dir="ltr">
                                                <!--end::Input-->
                                                <div class="fv-plugins-message-container invalid-feedback"></div></div>
                                            <!--end::Col-->
                                            <!--begin::Col-->
                                            <div class="col-md-6 fv-row fv-plugins-icon-container">
                                                ...
                                                <!--end::Label-->
                                                <!--begin::Input-->
                                                <input type="text" class="form-control" placeholder="{{ __('messages.attribute_name') }} ({{ __('messages.ar') }})" name="name_ar" dir="rtl">
                                                <!--end::Input-->
                                                <div class="fv-plugins-message-container invalid-feedback"></div></div>
                                            <!--end::Col-->
                                        </div>
                                    ...
                                    <div class="row g-9 mb-7">
                                        ...
                                        <div class="col-md-6 fv-row fv-plugins-icon-container">
                                            ...
                                            <div class="form-check form-switch form-check-custom form-check-success form-check-solid">
                                                <input class="form-check-input" name="colour_palette" type="checkbox" value="1" id="colour_palette">
                                            </div>
                                         <div class="fv-plugins-message-container invalid-feedback"></div></div>
                                        <!--end::Col-->
                                        <!--begin::Col-->
...
@push('footer-scripts')
    ...
    <script src="{{ asset('assets/js_tree/jstree.min.js') }}"></script>
    <script src="{{ asset('assets/js/admin/attributes/create_attributes.js') }}"></script>
