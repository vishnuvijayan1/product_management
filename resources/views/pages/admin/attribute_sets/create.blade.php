...
@section('title', __('messages.add_attribute_set'))
@push('breadcrumbs')
    <!--begin::Item-->
    ...
    <!--end::Item-->
    <!--begin::Item-->
    <li class="breadcrumb-item active"><a href="" class="text-muted text-hover-primary">{{  __('messages.add_attribute_set') }}</a></li>
    <!--end::Item-->
@endpush
@section('content')
    <!--begin::Content-->
                    ...
                    <div class="card">
                        ...
                        <div class="card-header border-0 pt-6">
                            ...
                            <div class="card-title">
                                <h2>{{ __('messages.add_attribute_set') }}</h2>
                            </div>
                        </div>
                        <!--end::Card header-->
                        <!--begin::Card body-->
                        <div class="card-body pt-0">
                            <form class="form" action="#" id="addAttributeSetForm" enctype="multipart/form-data" method="POST">
                                <!--begin::Modal body-->
                                <div class="modal-body py-10 px-lg-17">
                                        ...
                                        <div class="row g-9 mb-7">
                                            ...
                                            <div class="col-md-6 fv-row fv-plugins-icon-container">
                                                ...
                                                <!--end::Label-->
                                                <!--begin::Input-->
                                                <input type="text"class="form-control" placeholder="{{ __('messages.attribute_set_name') }} ({{ __('messages.en') }})" name="name" dir="ltr">
                                                <!--end::Input-->
                                            ...
                                            <div class="col-md-6 fv-row fv-plugins-icon-container">
                                                ...
                                                <!--end::Label-->
                                                <!--begin::Input-->
                                                <input type="text" class="form-control" placeholder="{{ __('messages.attribute_set_name') }} ({{ __('messages.ar') }})" name="name_ar" dir="rtl">
                                                <!--end::Input-->
                                                <div class="fv-plugins-message-container invalid-feedback"></div></div>
                                            <!--end::Col-->
                                        </div>
                                    ...
                                    <div class="row g-9 mb-7">
                                        ...
                                        <div class="col-md-12 fv-row fv-plugins-icon-container">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <select class="form-select" id="attributes" name="attribute_id[]" data-control="select2" data-placeholder="{{ __('messages.select_any') }}" data-maximum-selection-length="2" data-allow-clear="true"  multiple="multiple">
                                                @foreach($attributes as $attribute)
                                                <option value="{{ $attribute->id }}">{{ $attribute->getAttributeName() }}</option>
                                               @endforeach
                                            </select>
...
@push('footer-scripts')
    ...
    <script src="{{ asset('assets/js_tree/jstree.min.js') }}"></script>
    <script src="{{ asset('assets/js/admin/attribute_sets/create_attribute_sets.js') }}"></script>
@endpush
