...
@push('breadcrumbs')
    <!--begin::Item-->
    <li class="breadcrumb-item active"><a href="" class="text-muted text-hover-primary">{{  __('messages.users') }}</a></li>
    <!--end::Item-->
@endpush
@section('content')
    <!--begin::Content-->
                  ...
                  <div class="card">
                    ...
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-title">
                            <h2>{{ __('messages.user_lists') }}</h2>
                        </div>
                        <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">

                                <a class="btn btn-icon btn-active-light-primary w-30px h-30px"  href="{{ route('admin.users.create') }}" >
                    ...
                    <div class="card-body pt-0">
                        <table id="userDataTable" class="table table-row-bordered gy-5">
                            <thead>
