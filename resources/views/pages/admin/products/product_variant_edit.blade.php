<form class="form  mx-auto" novalidate="novalidate" id="editProductVariantForm">
    ...
    <div class="row g-9 mb-7">
        ...
        @elseif($product->sale_type == 'Auction')
            <div class="col-md-4 fv-row fv-plugins-icon-container">
                <label class="required fs-6 fw-semibold mb-2">{{ __('messages.quantity') }}</label>
                <input type="text" class="form-control" placeholder="{{ __('messages.quantity') }}" name="quantity" dir="ltr" @if(isset($product_variant)) value="{{ $product_variant->quantity }}" @endif>                                                           <!--end::Input-->
                <div class="fv-plugins-message-container invalid-feedback"></div>
            </div>
            <div class="col-md-4 fv-row fv-plugins-icon-container">
            ...
            <div class="col-md-6 fv-row fv-plugins-icon-container">
                ...
                <input type="text" class="form-control" placeholder="{{ __('messages.estimate_start_price') }}" name="estimate_start_price" dir="ltr" @if(isset($product_variant)) value="{{ $product_variant->estimate_start_price }}" @endif>                                                           <!--end::Input-->
                <div class="fv-plugins-message-container invalid-feedback"></div>
            </div>
            <div class="col-md-6 fv-row fv-plugins-icon-container">
    ...
    <div class="row g-9 mb-7">
        <div class="col-md-12 fv-row fv-plugins-icon-container">
            ...
            <div class="form-check form-switch form-check-custom form-check-success form-check-solid">
                <input class="form-check-input" name="status" type="checkbox"  value="1" id="status" @if(isset($product_variant) && $product_variant->status) checked @endif>
            </div>
            <div class="fv-plugins-message-container invalid-feedback"></div>
        </div>
    </div>
    ...
    <button id="editProductVariantButton" class="btn btn-primary float-end mb-5">
