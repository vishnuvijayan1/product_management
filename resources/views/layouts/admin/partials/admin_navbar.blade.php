    ...
    <div class="app-navbar-item ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
        ...
        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
            ...
            <div class="menu-item px-5" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="left-start" data-kt-menu-offset="-15px, 0">
                <a href="#" class="menu-link px-5">
                    ...
                    @if(session()->get('locale') == 'ar')
                        <span class="fs-8 rounded bg-light px-3 py-2 position-absolute translate-middle-y top-50 end-0">{{ __('messages.arabic') }}
                        <img class="w-15px h-15px rounded-1 ms-2" src="{{ asset('assets/media/flags/kuwait.svg') }}" alt="" /></span></span>
                    @else
                        <span class="fs-8 rounded bg-light px-3 py-2 position-absolute translate-middle-y top-50 end-0">{{ __('messages.english') }}
            ...
            <div class="menu-item px-5 my-1">
                <a href="" class="menu-link px-5">{{ __('messages.account_settings') }}</a>
            </div>
            <!--end::Menu item-->
            <!--begin::Menu item-->
            <div class="menu-item px-5">
                <a href="{{ route('admin.logout') }}" class="menu-link px-5">{{ __('messages.sign_out') }}</a>
            </div>
            <!--end::Menu item-->
        </div>
