...
<div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true" data-kt-drawer-name="app-sidebar" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="225px" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_app_sidebar_mobile_toggle">
    ...
    <div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
        <!--begin::Logo image-->
        <a href="{{ url('admin') }}">
            <img alt="Logo" src="{{ asset('assets/media/logos/logo.png') }}" class="h-50px app-sidebar-logo-default" />
            <img alt="Logo" src="{{ asset('assets/media/logos/logo-small.png') }}" class="h-20px app-sidebar-logo-minimize" />
        </a>
        <!--end::Logo image-->
                ...
                <div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
                    ...
                    <div class="menu-item pt-5">
                        ...
                        <div class="menu-content">
                            <span class="menu-heading fw-bold text-uppercase fs-7">{{ __('messages.user') }}</span>
                        </div>
                        <!--end:Menu content-->
                    </div>
                    <!--end:Menu item-->
                    ...
                    <div class="menu-item pt-5">
                        <!--begin:Menu content-->
                        <div class="menu-content">
                            <span class="menu-heading fw-bold text-uppercase fs-7">{{ __('messages.vendor') }}</span>
                        </div>
                        <!--end:Menu content-->
                    </div>
                    <!--end:Menu item-->
                    ...
                    <div class="menu-item">
                        <!--begin:Menu link-->
                        <a class="menu-link {{ (request()->is('admin/user_boutiques*')) ? 'active' : '' }}" href="{{ route('admin.user_boutiques.index') }}">
											<span class="menu-icon">
												<!--begin::Svg Icon | path: icons/duotune/coding/cod003.svg-->
												<span class="svg-icon svg-icon-2">
													<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <span class="menu-title">{{ __('messages.boutiques') }}</span>
                        </a>
                        <!--end:Menu link-->
                    </div>
                    <!--end:Menu item-->
                    ...
                    <div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
                        ...
                        <div class="menu-item pt-5">
                            <!--begin:Menu content-->
                            <div class="menu-content">
                                <span class="menu-heading fw-bold text-uppercase fs-7">{{ __('messages.product') }}</span>
                            </div>
                            <!--end:Menu content-->
                        </div>
                        <!--end:Menu item-->
                        ...
                        <div class="menu-item">
                            <!--begin:Menu link-->
                            <a class="menu-link {{ (request()->is('admin/categories*')) ? 'active' : '' }}" href="{{ route('admin.categories.index') }}">
											<span class="menu-icon">
												<!--begin::Svg Icon | path: icons/duotune/coding/cod003.svg-->
												<span class="svg-icon svg-icon-2">
													<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                            <!--begin:Menu link-->
                            <span class="menu-link {{ (request()->is('admin/attributes*') || request()->is('admin/attribute_sets*')) ? 'active' : '' }}">
											<span class="menu-icon">
                            ...
                            <div class="menu-sub menu-sub-accordion">
                                ...
                                <div class="menu-item">
                                    <!--begin:Menu link-->
                                    <a class="menu-link {{ (request()->is('admin/attributes')) ? 'active' : '' }}" href="{{ route('admin.attributes.index') }}">
                                ...
                                <div class="menu-item">
                                    <!--begin:Menu link-->
                                    <a class="menu-link {{ (request()->is('admin/attribute_sets')) ? 'active' : '' }}" href="{{ route('admin.attribute_sets.index') }}">
													<span class="menu-bullet">
														<span class="bullet bullet-dot"></span>
													</span>
                                        <span class="menu-title">{{ __('messages.attribute_sets') }}</span>
                                    </a>
                                    <!--end:Menu link-->
                                </div>
                                <!--end:Menu item-->
                        ...
                        <div class="menu-item">
                            <!--begin:Menu link-->
                            <a class="menu-link {{ (request()->is('admin/products*')) ? 'active' : '' }}" href="{{ route('admin.products.index') }}">
											<span class="menu-icon">
												<!--begin::Svg Icon | path: icons/duotune/coding/cod003.svg-->
												<span class="svg-icon svg-icon-2">
													<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="menu-item">
                            ...
                            <a class="menu-link" href="">
                                ...
                                <span class="menu-title">{{ __('messages.bulk_upload') }}</span>
                            </a>
                            <!--end:Menu link-->
                        </div>
                        <!--end:Menu item-->
                        ...
                        <div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
                            ...
                            <div class="menu-item pt-5">
                                <!--begin:Menu content-->
                                <div class="menu-content">
                                    <span class="menu-heading fw-bold text-uppercase fs-7">{{ __('messages.inventory') }}</span>
                                </div>
                                <!--end:Menu content-->
                            </div>
                            <!--end:Menu item-->
                                ...
                                <div class="menu-sub menu-sub-accordion">
                                    ...
                                    <div class="menu-item">
                                        ...
                                        <a class="menu-link " href="">
                                            ...
                                            <span class="menu-title">{{ __('messages.sale') }}</span>
                                        </a>
                                        <!--end:Menu link-->
                                    </div>
                                    <!--end:Menu item-->
                                    ...
                                    <div class="menu-item">
                                        ...
                                        <a class="menu-link" href="">
                                            ...
                                            <span class="menu-title">{{ __('messages.auction') }}</span>
                                        </a>
                                        <!--end:Menu link-->
                                    </div>
                                    <!--end:Menu item-->
                                    ...
                                    <div class="menu-item">
                                        ...
                                        <a class="menu-link " href="">
                                            ...
                                            <span class="menu-title">{{ __('messages.bulk') }}</span>
                                        </a>
                                        <!--end:Menu link-->
                                    </div>
                                    <!--end:Menu item-->
                                    ...
                                    <div class="menu-item">
                                        ...
                                        <a class="menu-link" href="">
                                            ...
                                            <span class="menu-title">{{ __('messages.live') }}</span>
                                        </a>
                                        <!--end:Menu link-->
                                    </div>
                                    <!--end:Menu item-->
                            ...
                            <div class="menu-item">
                                ...
                                <a class="menu-link" href="">
                                    ...
                                    <span class="menu-title">{{ __('messages.promo_codes') }}</span>
                                </a>
                                <!--end:Menu link-->
                            </div>
                            <!--end:Menu item-->
                            ...
                            <div class="menu-item">
                                ...
                                <a class="menu-link" href="">
                                    ...
                                    <span class="menu-title">{{ __('messages.stock') }}</span>
                                </a>
                                <!--end:Menu link-->
                            </div>
                            <!--end:Menu item-->
                        ...
                        <div class="menu-item pt-5">
                            <!--begin:Menu content-->
                            <div class="menu-content">
                                <span class="menu-heading fw-bold text-uppercase fs-7">{{ __('messages.app_cms') }}</span>
                            </div>
                            <!--end:Menu content-->
                        </div>
                        <!--end:Menu item-->
                        ...
                        <div class="menu-item">
                            <!--begin:Menu link-->
                            <a class="menu-link {{ (request()->is('admin/app_banners*')) ? 'active' : '' }}" href="{{ route('admin.app_banners.index') }}">
											<span class="menu-icon">
												<!--begin::Svg Icon | path: icons/duotune/coding/cod003.svg-->
												<span class="svg-icon svg-icon-2">
													<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <span class="menu-title">{{ __('messages.app_banners') }}</span>
                            </a>
                            <!--end:Menu link-->
                        </div>
                        <!--end:Menu item-->
                            ...
                            <div class="menu-item">
                                ...
                                <a class="menu-link" href="">
                                    ...
                                    <span class="menu-title">{{ __('messages.sales_report') }}</span>
                                </a>
                                <!--end:Menu link-->
                            </div>
                            <!--end:Menu item-->
                            ...
                            <div class="menu-item">
                                ...
                                <a class="menu-link" href="">
                                    ...
                                    <span class="menu-title">{{ __('messages.payment_report') }}</span>
                                </a>
                                <!--end:Menu link-->
                            </div>
                            <!--end:Menu item-->
                            ...
                            <div class="menu-item pt-5">
                                <!--begin:Menu content-->
                                <div class="menu-content">
                                    <span class="menu-heading fw-bold text-uppercase fs-7">{{ __('messages.basic') }}</span>
                                </div>
                                <!--end:Menu content-->
                            </div>
                            <!--end:Menu item-->
                            ...
                            <div class="menu-item">
                                ...
                                <a class="menu-link" href="">
                                    ...
                                    <span class="menu-title">{{ __('messages.sales_commission') }}</span>
                                </a>
                                <!--end:Menu link-->
                            </div>
                            <!--end:Menu item-->
                            ...
                            <div class="menu-item">
                                ...
                                <a class="menu-link" href="">
                                    ...
                                    <span class="menu-title">{{ __('messages.delivery_charges') }}</span>
                                </a>
                                <!--end:Menu link-->
                            </div>
                            <!--end:Menu item-->
    ...
    <div class="app-sidebar-footer flex-column-auto pt-2 pb-6 px-6" id="kt_app_sidebar_footer">
        <a href="{{ url('') }}" class="btn btn-flex flex-center btn-custom btn-primary overflow-hidden text-nowrap px-0 h-40px w-100" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss-="click" title="Vendor Panel">
            <span class="btn-label">{{ __('messages.vendor_panel') }}</span>
